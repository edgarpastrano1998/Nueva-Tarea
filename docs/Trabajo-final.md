...
Si la base de datos pierde conexión durante 10 minutes, el Backend API no podrá consultar usuarios ni playlists. El Frontend seguirá funcionando parcialmente, permitiendo al usuario navegar por la aplicación y reproducir canciones descargadas localmente.
...
Almacenamiento Cloud,AWS S3,Almacenar el catálogo de canciones en la nube,LocalStack / AWS Dev
...
Nota de Arquitectura: Esta sección define las interfaces de comunicación entre los contenedores del sistema a través de contratos estrictos basados en formato JSON para el intercambio de información.
